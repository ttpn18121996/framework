...
class Response
{
    ...
    /**
     * Chuyển kiểu dữ liệu trả về dạng json.
     *
     * @param  mixed  $data
     * @return $this
     */
    ...
    public function redirect($location = '', array $options = [])
    {
        ...
        if (! empty($options)) {
            foreach ($options as $headerKey => $headerValue) {
    ...
    /**
     * Chuyển hướng sang trang khác theo route name.
     *
     * @param  string  $name
     * @param  array  $params
     * @return $this
    ...
    public function route($name, $params = [])
    {
        ...
        if (! empty($params)) {
            foreach ($params as $paramKey => $paramValue) {
                $uri = Str::replace($uri, '{'.$paramKey.'}', $paramValue);
            }
        }
