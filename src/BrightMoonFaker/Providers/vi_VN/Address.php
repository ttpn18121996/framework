...
use BrightMoonFaker\Providers\Address as BaseAddress;
...
class Address extends BaseAddress
{
    public $provinces = [
        ...
        'Hải Phòng', 'Hậu Giang', 'Hòa Bình', 'Thành phố Hồ Chí Minh', 'Hưng Yên', 'Khánh Hòa', 'Kiên Giang', 'Kon Tum',
    ...
    public $cities = [
        'Hà Nội', 'Hải Phòng', 'Đà Nẵng', 'Hồ Chí Minh', 'Cần Thơ',
    ];
}
